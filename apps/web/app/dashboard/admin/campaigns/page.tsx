...
export default async function CampaignsPage() {
  ...
  const { data: campaigns } = await supabase
    .from("campaigns")
    .select("id, name, template_name, template_category, status, total_recipients, sent_count, delivered_count, read_count, failed_count, clicked_count, created_at, pause_reason")
