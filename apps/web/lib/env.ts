...
export const env = createEnv({
  ...
  client: {
    ...
    // Endereço público do que o fã abre (hoje https://link.plauz.com.br).
    // Opcional: sem ele, o link mostrado cai no host da requisição, que é o
    // certo em desenvolvimento. Existe porque o painel é aberto por vários
